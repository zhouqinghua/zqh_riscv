...
class zqh_spi_flash_xip_ctrl_parameter(zqh_tilelink_node_module_parameter):
    def set_par(self):
        super(zqh_spi_flash_xip_ctrl_parameter, self).set_par()

    def check_par(self):
        super(zqh_spi_flash_xip_ctrl_parameter, self).check_par()
